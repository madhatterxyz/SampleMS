...
function openDialog() {
    Office.context.ui.displayDialogAsync(window.location.origin + "/AlertPage.html",
        { height: 50, width: 50, displayInIframe: false }, dialogCallback);
}
...
function openDialogAsIframe() {
    ...
    //DisplayInIFrame to true avoid the popup for the user on the browser
    Office.context.ui.displayDialogAsync(window.location.origin + "/AlertPage.html",
